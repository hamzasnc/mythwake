...
func (router *Router) handleHealth(response http.ResponseWriter, request *http.Request) {
	...
	writeJSON(response, http.StatusOK, map[string]string{
		...
		"loaded_players":                strconv.Itoa(router.playerManager.LoadedPlayerCount()),
		"player_context_idle_ttl":       router.config.PlayerContextIdleTTL.String(),
		"player_context_sweep_interval": router.config.PlayerContextSweepInterval.String(),
