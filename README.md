...
- Unity editor validation covers the current gameplay/UI slice, including Village, Fast Rewards, Summon, Upgrade Clutter, Hero Detail gear spacing/localization/label fit, and Paladin handoff checks
