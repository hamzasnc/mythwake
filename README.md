...
- Hero Detail shows all equipment/accessory slots, uses localized contextual gear action labels, hints available bag copies on empty accessory slots, opens an inline list for the selected gear slot, and supports accessory removal locally and in Server Mode
