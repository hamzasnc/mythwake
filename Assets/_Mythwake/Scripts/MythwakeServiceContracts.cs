...
public struct MythwakeHealthDto
{
    ...
    public string session_cache_store;
    public string session_cache_ttl;
    public string session_touch_window;
    public string rate_limit_store;
    public string rate_limit_enabled;
    public string rate_limit_window;
    public string rate_limit_auth;
    public string rate_limit_gameplay;
    public string player_lock_store;
    public string player_lock_ttl;
    public string loaded_players;
    public string player_context_idle_ttl;
    public string player_context_sweep_interval;
    public string require_idempotency;
