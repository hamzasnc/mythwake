...
public static class BagInventoryRulesEditModeTests
{
    ...
    public static void Run()
    {
        ...
        Assert(BagInventoryRules.Filter(items, BagInventoryTab.All, 2, item => item).Count == 2, "All filtering should respect the grid page limit.");
        ...
        Debug.Log("Bag inventory rule EditMode checks passed: category filtering, grid limit, and quantity clamping are deterministic.");
    }
