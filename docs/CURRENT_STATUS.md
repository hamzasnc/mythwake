...
- Hero Detail now labels starter Weapon/Armor rows as training tracks instead of claiming they are equipped item instances; the validator guards that wording in the normal and German refresh paths.
