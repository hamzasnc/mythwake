...
- Hero Detail now renders the new armory background plus equipped accessory slot icon art, keeps starter Weapon/Armor training slots free of item icon art, and the upgrade clutter validator checks that equipped art loads, empty slots stay blank, everything fits, and icons do not intercept slot input.
