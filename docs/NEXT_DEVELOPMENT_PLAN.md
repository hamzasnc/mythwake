...
- The Bag runtime uses one generated asset pipeline: `Assets/Art/UI/BagGenerated` with `BagGeneratedSpriteCatalog`. The former Resources/prefab draft was removed after all runtime references were checked.
